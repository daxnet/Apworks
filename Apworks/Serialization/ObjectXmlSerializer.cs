...
namespace Apworks.Serialization
{
    ...
    public class ObjectXmlSerializer<TObject> : IObjectSerializer<TObject>
    {
        ...
        {
            NSXmlSerialization.XmlSerializer xmlSerializer = new NSXmlSerialization.XmlSerializer(destType);
